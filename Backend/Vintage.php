...
<body>
    ...
    <div class="grid-container">
            <div class="grid-item">
            <a href="#"><img src="../Shirt_designs/ShirtV1.png" alt="Shirt 1"></a>
            <form method="POST">
        ...
        <div class="grid-item">
            <a href="#"><img src="../Shirt_designs/ShirtV2.png" alt="Shirt 2"></a>
            <form method="POST">
        ...
        <div class="grid-item">
            <a href="#"><img src="../Shirt_designs/ShirtV3.png" alt="Shirt 2"></a>
            <form method="POST">
        ...
        <div class="grid-item">
            <a href="#"><img src="../Shirt_designs/ShirtV4.png" alt="Shirt 2"></a>
            <form method="POST">
        ...
        <div class="grid-item">
            <a href="#"><img src="../Shirt_designs/ShirtV5.png" alt="Shirt 2"></a>
            <form method="POST">
        ...
        <div class="grid-item">
            <a href="#"><img src="../Shirt_designs/ShirtV6.png" alt="Shirt 2"></a>
            <form method="POST">
